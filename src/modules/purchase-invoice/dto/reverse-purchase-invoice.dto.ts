...
/**
 * Reverse a POSTED purchase invoice. Reverses inventory, the supplier subledger
 * and the journal (opposite posted entry) inside one transaction, into the chosen
